...
struct TitleScreen: View {
    ...
    var splash: some View {
        ZStack {
            ...
            VStack {
                VStack(spacing: 24) {
                    Text("This experience was created for the WWDC21 Swift Student Challenge, originally as an Xcode Playground.")
                    Text("Now, it has been made available as a macOS app, completely unmodified.")
                        .foregroundStyle(.secondary)
                }
                .multilineTextAlignment(.center)
                .font(Font(getFontWithAlignedNumbers(font: "Raleway", size: 20)).weight(.medium))
            }
        }
        .padding(64)
